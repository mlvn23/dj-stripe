...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'djstripe_customer', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True, null=True))
        # Adding field 'CurrentSubscription.stripe_id'
        db.add_column(u'djstripe_currentsubscription', 'stripe_id',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'CurrentSubscription.stripe_id'
        db.delete_column(u'djstripe_currentsubscription', 'stripe_id')
